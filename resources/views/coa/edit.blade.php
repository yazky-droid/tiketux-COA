            ...
            <div class="bg-slate-200 p-10 shadow-sm rounded ">
                ...
                <div class="w-full flex flex-col items-center justify-center">
                    <div class="w-full max-w-xs mt-2">
                        <form action="{{ route('coa.update', $coa->id) }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" >
                            @csrf
                            @method('PUT')
                          <div class="mb-4">
                            ...
                            <input name="kode" value="{{ old('kode', $coa->kode) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline " type="text" placeholder="Add the code">
                          ...
                          <div class="mb-4">
                            ...
                            <input name="nama" value="{{ old('nama', $coa->nama) }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline " type="text" placeholder="Add the COA name">
